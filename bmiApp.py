...
weight = st.number_input("กรอกน้ำหนักส่วนสูงของคุณ (กิโลกรัม):", min_value=1.0)
...
if bmi < 18.5:
   ...
   st.info("💡 คุรเริ่มมีน้ำหนักเกณฑ์ (ท้วม)")
else:
   st.error("🚨 คุณอยู่ในเกณฑ์อ้วน ควรระวังเรื่องสุขภาพและออกกำลังกาย")

st.divider()
st.write("นางสาววิชญาพร บุญจันทร์ต๊ะ เลขที่ 16 ม.4/3")
